...
ext4-tests: $(BUILD_DIR)/vfs-vnode-host-test
...
qemu-test-ext4-symlink-powercuts qemu-test-ext4-symlink-long-powercuts qemu-test-ext4-chmod-powercuts qemu-test-ext4-times-powercuts: $(KERNEL) $(EXT4_FIXTURE) tools/ext4_unlink_powercut_test.py tools/ext4_powercut_test.py tools/ext4_kernel_read.py
