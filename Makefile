...
qemu-test-ext4-overwrite-errors-powercuts qemu-test-ext4-append-errors-powercuts qemu-test-ext4-truncate-errors-powercuts qemu-test-ext4-grow-errors-powercuts qemu-test-ext4-rename-errors-powercuts qemu-test-ext4-rename-cross-errors-powercuts qemu-test-ext4-create-errors-powercuts qemu-test-ext4-mkdir-errors-powercuts qemu-test-ext4-rmdir-errors-powercuts: $(KERNEL) $(EXT4_FIXTURE) tools/ext4_unlink_powercut_test.py tools/ext4_powercut_test.py tools/ext4_kernel_read.py
