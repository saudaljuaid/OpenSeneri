...
$(BUILD_DIR)/ext4-vfs-host-test $(BUILD_DIR)/ext4-handle-claims-host-test \
		...
		$(BUILD_DIR)/ext4-msix-close-host-test: include/phipia/slot_claim.h include/phipia/cpu.h
...
$(BUILD_DIR)/ext4-append-contention-host-test: tools/ext4-append-contention-host-test.c src/kernel/ext4_fs.c \
		include/phipia/ext4_fs.h include/phipia/nvme.h include/phipia/slot_claim.h
	mkdir -p $(dir $@)
	$(CC) -std=c11 -O2 -flto -ffunction-sections -fdata-sections \
		-Wall -Wextra -Werror -Wpedantic -Wshadow -Wconversion -Iinclude \
...
.PHONY: qemu-test-ext4-applications-inodes
qemu-test-ext4-applications-inodes: iso $(FAT32_SYSTEM_IMAGE)
	$(PYTHON) tools/ext4_application_space_test.py --inodes --iso $(ISO) \
		--system $(FAT32_SYSTEM_IMAGE) --ffmpeg $(FFMPEG) \
...
qemu-test-ext4-overwrite-errors-powercuts qemu-test-ext4-append-errors-powercuts qemu-test-ext4-truncate-errors-powercuts qemu-test-ext4-grow-errors-powercuts qemu-test-ext4-rename-errors-powercuts qemu-test-ext4-rename-cross-errors-powercuts qemu-test-ext4-create-errors-powercuts qemu-test-ext4-mkdir-errors-powercuts qemu-test-ext4-rmdir-errors-powercuts qemu-test-ext4-chmod-errors-powercuts qemu-test-ext4-times-errors-powercuts qemu-test-ext4-xattr-errors-powercuts qemu-test-ext4-xattr-remove-errors-powercuts: $(KERNEL) $(EXT4_FIXTURE) tools/ext4_unlink_powercut_test.py tools/ext4_powercut_test.py tools/ext4_kernel_read.py
